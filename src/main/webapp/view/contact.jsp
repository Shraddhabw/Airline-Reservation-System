...
<body>
	...
	<h3>BritishAirways Contact Form</h3>
	...
	<div class="container">
		<form action="contact" method="post">
			<label for="fname">Name</label> <input type="text" id="fname"
				...
				placeholder="Your last name.."> <label for="lname">phone
				no</label> <input type="text" id="lname" name="phone"
				placeholder="Your last name.."> <label for="message">Subject</label>
